...
project = "SNPmanifold"
author = "Kevin Chung"
title = "Manifold learning for single-cell single-nucleotide genetic variations"
...
import SNPmanifold
version = SNPmanifold.__version__ #'0.0.2' #
...
github_repo = 'SNPmanifold'
github_nb_repo = 'SNPmanifold'
...
latex_documents = [
  ('index', 'SNPmanifold.tex', u'SNPmanifold Documentation',
...
man_pages = [
    ('index', 'SNPmanifold', u'SNPmanifold Documentation',
     [u'Kevin Chung'], 1)
]
...
texinfo_documents = [
  ('index', 'SNPmanifold', u'SNPmanifold Documentation',
   u'Kevin Chung', 'SNPmanifold', 'One line description of project.',
   'Miscellaneous'),
]
